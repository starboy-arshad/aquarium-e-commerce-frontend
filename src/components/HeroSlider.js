      ...
      <div className="container">
        <div id="hero-carousel" className="owl-carousel inner-carousel owl-simple rows cols-1" ref={carouselRef} style={{width: '100%'}}>
          <div className="intro-slide" style={{position: 'relative', backgroundColor: "#2a323e", minHeight: '600px'}}>
            <video autoPlay muted loop playsInline style={{position: 'absolute', top: '50%', left: '50%', width: '100%', height: '100%', minWidth: '100%', minHeight: '100%', objectFit: 'cover', transform: 'translate(-50%, -50%)'}}>
            ...
            <div className="intro-content intro-content-left" style={{position: 'absolute', top: '50%', left: '10%', transform: 'translateY(-50%)', zIndex: 1}}>
